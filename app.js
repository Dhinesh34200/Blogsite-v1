...
mongoose.connect("mongodb+srv://admin-dhinesh:X4uxxTXPmqOnfdfY@cluster0.ozip6k2.mongodb.net/blogsDB",{useNewUrlParser:true});
// let posts=[];
...
app.get("/posts/:id",(req,res)=>{ 
  ...
  //   if(postTitle=== title){
  //     res.render("post",{postTitle:post.Title,postContent:post.Comment})
...
app.post("/compose",(req,res)=>{
  ...
  // let post={Title:req.body.itemTitle,Comment:req.body.postComment}
  // posts.push(post);
